    ...
    function() {
        ...
        var colorThemes = {
            ...
            'freshblue': {
                ...
                'name': 'COLOR.BLUE',
                'theme': ['fresh'],
                'url': ['css/themes/bootstrap-material-design_freshblue.min.css']
            },
            'lightblue': {
                'id': 'lightblue',
                'sample': '#03a9f4',
                ...
                'theme': ['light', 'default', 'traversed'],
                'url': ['css/themes/bootstrap-material-design_lightblue.min.css']
            },
            'cyan': {
                'id': 'cyan',
                'sample': '#00bcd4',
